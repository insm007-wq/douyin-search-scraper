# Vendored from Johnserf-Seed/f2 @ commit cca83bebcc4a798f92e44182abb0894586306022 (2025-03-05).
# Original path: f2/utils/abogus.py
# License: Apache License 2.0 — see LICENSES/f2-Apache-2.0.txt
# Original author: Johnserf-Seed <support@f2.wiki> (https://github.com/Johnserf-Seed)
#
# Modifications by SynergyNano:
#   - 2026-05-07: Vendored as-is (no functional changes). Header prepended.
#                 Algorithm revision tracking constant added below for upstream
#                 sync detection — bump _ABOGUS_REVISION when re-vendoring.
#
# Per Apache-2.0 §4(a)/(b)/(c): LICENSE retained, modifications listed, attribution
# preserved. NOTICE excerpt (this product includes software developed by Johnserf-Seed)
# lives in NOTICE.

_ABOGUS_REVISION = "f2@cca83be (2025-03-05)"
